...
(function () {
  ...
  window.addEventListener('message', function (event) {
    ...
    if (event.data.type === 'threeui-mousemove') {
      if (window.__SF_MOUSE_UPDATE) window.__SF_MOUSE_UPDATE(event.data.clientX, event.data.clientY);
      return;
    }
